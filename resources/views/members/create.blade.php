    ...
    <div class="col-8 col-offset-2 mx-auto">
        ...
        <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <div class="col-sm-12">
                    <input type="text" name="tel" value="{{ old('tel') }}" class="form-control @if ($errors->has('tel')) is-invalid @endif"
            ...
            <div class="mb-4">
                ...
                <div class="col-sm-12">
                    <input type="file" name="file[]" value="{{ old('file') }}" class="form-control" multiple="multiple"
                        required>
                </div>
            </div>
            <div class="mb-4">
